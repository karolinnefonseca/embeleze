            ...
            <div id="sidebar-scrollbar">
               <nav class="iq-sidebar-menu">
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                     ...
                     <li class="active"><a href="#" class="iq-waves-effect collapsed"  data-toggle="collapse" aria-expanded="false"><i class="fa fa-user" aria-hidden="true"></i><span>Área do Cliente</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a></li>
					 <li><a href="form_agenda.php?edi=<?php echo $campos['email'];?>" class="iq-waves-effect collapsed"  data-toggle="collapse" aria-expanded="false"><i class="fa fa-calendar-check-o" aria-hidden="true"></i><span>Marque sua agenda</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a></li>			 
                  </ul>
               </nav>
               <div class="p-3"></div>
            </div>
               ...
               <div class="navbar-breadcrumb">
                  ...
                  <nav aria-label="breadcrumb">
                     <ul class="breadcrumb">
                        ...
                        <li class=""><i class="fa fa-arrow-right" aria-hidden="true"></i> Área do Cliente</li>
                     </ul>
                  </nav>
               </div>
...
<?php
        include("conexao.php");
		$user_cliente=$campos['nome_cliente'];
		$user_email=$campos['email'];
        $view_users_query="SELECT * FROM agenda WHERE nome_cliente='$user_cliente'";	
        ...
        <tr>
		   ...
		   <td><a href="deleta_agenda.php?del=<?php echo $user_id?>&edi=<?php echo $user_email?>"><button class="btn btn-danger">Excluir</button></a></td>
        </tr>
 <?php } ?>			
			 </table> <!--FIM DA TABELA-->	
