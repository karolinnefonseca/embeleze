            ...
            <div class="iq-sidebar-logo">
               ...
               <img src="img/ortolabor.png" class="img-fluid" alt="">
			    ...
			    <?php
							...
							include("conexao.php");
							$id = $_GET['servico'];
							$result = "SELECT *FROM servico where id= '$id' ";
            ...
            <div id="sidebar-scrollbar">
               <nav class="iq-sidebar-menu">
                  <ul id="iq-sidebar-toggle" class="iq-menu">
					 ...
					 <li><a href="#" class="iq-waves-effect collapsed"  data-toggle="collapse" aria-expanded="false"><i class="ri-home-4-line"></i><span>Editar Serviço</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a></li>					 
                  </ul>
               </nav>
               <div class="p-3"></div>
            </div>
		 ...
		 <div class="navbar">
            <div class="iq-navbar-custom">
               ...
               <div class="navbar-breadcrumb">
                  ...
                  <h5 class="mb-0">Editar Serviço: <?php echo $campos['nome'];?></h5>
                  <nav aria-label="breadcrumb">
                     <ul class="breadcrumb">
                        <li class="breadcrumb-item"><i class="fa fa-arrow-right" aria-hidden="true"></i> Editar Serviço</a></li>
                     </ul>
                  </nav>
               </div>
...
<form action="editar_cadastro_servico.php" method="POST">
<!--FORM SERVIÇO--> 
 <input type="hidden" name="edi" value="<?php echo $campos['id'];?>"></input>
  <div class="form-row">
     
    <div class="form-group col-md-4">
	 <label for="exampleFormControlSelect1"><b>Nome do Serviço</b></label>
      <input type="text" name="nomeservico"class="form-control" value="<?php echo $campos['nome'];?>">
    </div>

										<div class="form-group col-md-4">
										<label><b>Vinculado ao Produto</b></label>
										<select class="form-control" name="id_produto" id="id_produto">
										<option value="" selected = selected>Selecione...</option>
										<?php
										include("conexao.php");
										$resultstatus = "SELECT *from produto ORDER BY nome ASC ";
  ...
  <div class="form-group col-md-4">
      ...
      <input input id="dataservico" name="dataservico"type="date" class="form-control" value="<?php echo $campos['dataservico'];?>">
    </div>
...
<div class="form-group">
    ...
    <textarea class="form-control" name="obsservico"id="exampleFormControlTextarea1" rows="3"><?php echo $campos['obsservico'];?></textarea>
</div>
