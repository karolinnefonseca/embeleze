...
<html lang="en">
   <head>
      ...
      <title>Faturamento Cadastrados</title>
      <!-- Favicon -->
            ...
            <div id="sidebar-scrollbar">
               <nav class="iq-sidebar-menu">
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                     ...
                     <li class="active"><a href="#" class="iq-waves-effect collapsed"  data-toggle="collapse" aria-expanded="false"><i class="ri-home-4-line"></i><span>Faturamentos cadastrados</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a></li>
                  </ul>
               </nav>
               <div class="p-3"></div>
            </div>
		 ...
		 <div class="navbar">
            <div class="iq-navbar-custom">
               ...
               <div class="navbar-breadcrumb">
                  ...
                  <h5 class="mb-0">Detalhamento dos Faturamentos</h5>
                  <nav aria-label="breadcrumb">
                     <ul class="breadcrumb">
						<li><i class="fa fa-usd" aria-hidden="true"></i> Faturamentos</li>
                     </ul>
                  </nav>
               </div>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                       <div class="user-detail pl-5">
                                          <div class="d-flex flex-wrap align-items-center">
                                                ...
                                                <h2><i class="fa fa-table" aria-hidden="true"></i> Tabela Faturamentos</h2>
