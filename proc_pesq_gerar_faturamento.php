...
$result_user = "SELECT id_faturamento, nomecliente, paciente,tiposervico,valor, desconto, valortotal, valorpago FROM faturamento";
$resultado_user =mysqli_query($con, $result_user);
$qnt_linhas = mysqli_num_rows($resultado_user);

//Obter os dados a serem apresentados
$result_usuarios = "SELECT id_faturamento, nomecliente, paciente,tiposervico,valor, desconto, valortotal, valorpago FROM faturamento  WHERE 1=1 ";
