	...
	<link rel="shortcut icon" href="img/usuario.png" type="image/x-icon">
     ...
     <script src="js/main.js"></script>
		...
		$(document).ready(function() {
			$('#listar-servico').DataTable({			
				"processing": true,
				"serverSide": true,
				"ajax": {
					"url": "proc_pesq_servico.php",
					"type": "POST"
				},
				'columnDefs' : [
            ...
            <div id="sidebar-scrollbar">
               <nav class="iq-sidebar-menu">
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                     ...
                     <li class="active"><a href="#" class="iq-waves-effect collapsed"  data-toggle="collapse" aria-expanded="false"><i class="ri-home-4-line"></i><span>Serviços cadastrados</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a></li>
                  </ul>
               </nav>
               <div class="p-3"></div>
            </div>
		 ...
		 <div class="navbar">
            <div class="iq-navbar-custom">
               ...
               <div class="navbar-breadcrumb">
                  ...
                  <h5 class="mb-0">Detalhamento de Serviços Cadastrados</h5>
                  <nav aria-label="breadcrumb">
                     <ul class="breadcrumb">
						<li><i class="fa fa-user-circle-o" aria-hidden="true"></i> Serviços Cadastrados</li>
                     </ul>
                  </nav>
               </div>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                       <div class="user-detail pl-5">
                                          <div class="d-flex flex-wrap align-items-center">
                                                ...
                                                <h2><i class="fa fa-table" aria-hidden="true"></i> Tabela de serviços</h2>
 ...
 <!-- / INÍCIO DOS DADOS DA TABELA NÚMERO 01------------------------------------------------------------------------------------------------------------------------------------------------------>		
		...
		<div class="card mb-3">
			 <div class="card-body">
			  ...
			  <table class="table table-striped" id="listar-servico" class="display" style="width:100%">
			  <thead>
                <tr>
				<th>id do Serviço</th>
                  <th>Serviço</th>
