            ...
            <div id="sidebar-scrollbar">
               <nav class="iq-sidebar-menu">
                  <ul id="iq-sidebar-toggle" class="iq-menu">
					 <li class="active"><a href="#" class="iq-waves-effect collapsed"  data-toggle="collapse" aria-expanded="false"><i class="fa fa-calendar-check-o" aria-hidden="true"></i><span>Editar Agenda</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a></li>			 
                  </ul>
               </nav>
               <div class="p-3"></div>
            </div>
               ...
               <div class="navbar-breadcrumb">
                  ...
                  <nav aria-label="breadcrumb">
                     <ul class="breadcrumb">
						...
						<li class="breadcrumb-item"><i class="fa fa-arrow-right" aria-hidden="true"></i> Editar Agenda</a></li>
                     </ul>
                  </nav>
               </div>
            ...
            <div class="container-fluid">
               <div class="row">
			    ...
			    <?php
							...
							$result_cliente = "SELECT *FROM agenda where id_agenda= '$id_cliente' ";
							$resultado_cliente = mysqli_query($con, $result_cliente);
							$row_cliente = mysqli_fetch_assoc($resultado_cliente);
							$campos_cliente= $row_cliente;	
							
							
				
				?>
<form action="editar_agenda_cadastrada.php" method="POST">
<!--FORM NOME--> 
 <input type="hidden" name="agenda" value="<?php echo $campos_cliente['id_agenda'];?>"></input>
  ...
  <div class="form-row">
    <div class="form-group col-md-12">
      <input type="text" name="nomecliente"class="form-control" value="<?php echo $campos_cliente['nome_cliente'];?>">
    </div>
    ...
    <div class="form-group col-md-6">
      ...
      <input input name="data"id="inputdate" type="date" class="form-control" value="<?php echo $campos_cliente['data_agenda'];?>">
    </div>
  </div>
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input input name="tel"id="inputTEL" type="text" class="form-control" onkeypress="mask(this, mphone);" onblur="mask(this, mphone);" value="<?php echo $campos_cliente['telefone'];?>">
    </div>
    <div class="form-group col-md-6">
    <label for="exampleFormControlTextarea1"><b>Observação:</b></label>
    <textarea class="form-control" name="obs"id="exampleFormControlTextarea1" rows="3" value="<?php echo $campos_cliente['obs'];?>"></textarea>
    </div>
  </div>

  <div  class="row justify-content-end">
  <button type="submit" name="editar"class="btn btn-success">Editar Agenda</button>
</div> 
