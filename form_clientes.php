            ...
            <div id="sidebar-scrollbar">
               <nav class="iq-sidebar-menu">
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                     ...
                     <li class="active"><a href="form_clientes.php" class="iq-waves-effect collapsed"  data-toggle="collapse" aria-expanded="false"><i class="ri-home-4-line"></i><span>Clientes</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a></li>
            ...
            <div class="iq-navbar-custom">
               ...
               <div class="navbar-breadcrumb">
                  ...
                  <nav aria-label="breadcrumb">
                     <ul class="breadcrumb">
						<li class=""><a href="index_embelez.php?edi=<?php echo $campos['login'];?>"><i class="fa fa-home" aria-hidden="true"></i> Página Inicial</a></li>
                        <li class=""><i class="fa fa-arrow-right" aria-hidden="true"></i> Área Administrativa</li>
						<li class="breadcrumb-item"><i class="fa fa-arrow-right" aria-hidden="true"></i> Cadastrar Cliente</a></li>
                     </ul>
                  </nav>
               </div>
