            ...
            <div id="sidebar-scrollbar">
               ...
               <nav class="iq-sidebar-menu">
                  <ul id="iq-sidebar-toggle" class="iq-menu">
					 ...
					 <li><a href="form_banco_de_talentos.php?edi=<?php echo $campos['login'];?>" class="iq-waves-effect collapsed"  data-toggle="collapse" aria-expanded="false"><i class="ri-home-4-line"></i><span>Banco de Talentos</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a></li>
					 ...
					 <li class="active"><a href="form_estoque.php?edi=<?php echo $campos['login'];?>" class="iq-waves-effect collapsed"  data-toggle="collapse" aria-expanded="false"><i class="ri-home-4-line"></i><span>Estoque/Insumos</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a></li>
               ...
               <div class="navbar-breadcrumb">
                  ...
                  <nav aria-label="breadcrumb">
                     <ul class="breadcrumb">
						...
						<li class="breadcrumb-item"><i class="fa fa-arrow-right" aria-hidden="true"></i> Cadastrar Estoque</a></li>
                     </ul>
                  </nav>
               </div>
 ...
 <div class="form-row">
  <div class="form-group col-md-6">
	<label><b>Código do material</b></label>
      <input type="text" name="codmaterial"class="form-control" placeholder="Código do material">
  </div>
    <div class="form-group col-md-6">
...
<label><b>Material utilizado</b></label>
      <input type="text" name="material"class="form-control" placeholder="Material utilizado">
</div>
<div class="form-group col-md-4">
...
<div class="form-group col-md-4">
  ...
  <input type="text" name="valor"class="form-control" onKeyPress="return(moeda(this,'.',',',event))" placeholder="Digite o valor">
</div>
</div>

    <label for="exampleFormControlTextarea1"><b>Observações</b></label>
    <input class="form-control" name="obs"id="exampleFormControlTextarea1" ></input>

  <div  class="row justify-content-end">
  <button type="submit"name="salvar" class="btn btn-primary">Salvar</button>
  <div class="ml-1">
  <a href="estoque_cadastrado.php" target="_blank" type="submit" class="btn btn-success">Pesquisar</a>    
  </div>
  <div class="ml-1">
